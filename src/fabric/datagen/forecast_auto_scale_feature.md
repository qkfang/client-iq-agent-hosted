...
```bash
python main_generate_inventory.py --auto-scale -s 2025-01-01 -e 2026-03-31 --copydata .\output_copydata\data
```
...
python main_generate_inventory.py -s 2025-01-01 -e 2026-03-31 --num-orders 50 --num-transactions 800
