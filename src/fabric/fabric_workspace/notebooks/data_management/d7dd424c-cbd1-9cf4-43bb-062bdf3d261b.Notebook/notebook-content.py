...
print("📅 Dropping Shared schema tables...")
...
for table in shared_tables:
    try:
        spark.sql(f"DROP TABLE IF EXISTS shared.{table}")
        print(f"   ✅ shared.{table} dropped")
    except Exception as e:
        print(f"   ❌ Error dropping shared.{table}: {str(e)}")

print("✅ Shared schema table drop complete!")
